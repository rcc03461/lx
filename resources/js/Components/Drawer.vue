...
<template>
    <aside ref="drawer" v-if="isOpen" class="drawer fixed z-[1001] inset-0 h-screen w-screen shadow-md">
        ...
        <div class="drawer-container w-screen h-screen max-w-4xl flex flex-col absolute right-0 top-0 rounded-md bg-white">
            ...
            <div class="drawer-content flex-1 overflow-y-auto px-2 gap-1">
                <slot></slot>
            </div>
            <div class="drawer-footer w-full flex justify-end p-2 gap-1">
